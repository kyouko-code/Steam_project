            ...
            <table class="min-w-full divide-y divide-gray-700">
                <thead class="bg-gray-900">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Genres</th>
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center text-gray-400">No games yet. <a href="{{ route('admin.games.create') }}" class="text-blue-400 hover:text-blue-300">Add your first game</a></td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
